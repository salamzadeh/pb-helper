...
class BasicTest extends TestCase
{
    ...
    public function testMiddleware()
    {
        ...
        $middleware = new \PBHelper\Middleware\FixRequestInputs;
    ...
    protected function setUp(): void
    {
        ...
        $this->seed(\PBHelper\Database\CitiesTableSeeder::class);
    }

    protected function getPackageProviders($app)
    {
        return [\Cviebrock\EloquentSluggable\ServiceProvider::class, \PBHelper\PBHelperServiceProvider::class];
    }
}
